...
public class HotelReservation {
    ...
    public static void main(String[] args) {
        ...
        //String input = "Regular: 16Aug2022(mon), 17Aug2022(tue), 18Aug2022(wed)"; //-> LakeWood
        String input = "Rewards: 26Aug2022(thu), 27Agu2022(fri), 28Agu2022(sat)"; // -> RidgeWood
        HotelReservation hotelRoom = new HotelReservation();
